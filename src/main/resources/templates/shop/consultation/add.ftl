...
<title>${product.name} ${message("shop.consultation.title")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<link href="${base}/shop/css/consultation.css" rel="stylesheet" type="text/css" />
