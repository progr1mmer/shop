...
<title>${message("shop.member.receiver.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
	...
	<div class="container member">
		...
		<div class="span18 last">
			<div class="list">
				...
				<div class="bar">
					<a href="add.html" class="button">${message("shop.member.receiver.add")}</a>
				</div>
				<table id="listTable" class="list">
					...
					[#list page.content as receiver]
						<tr[#if !receiver_has_next] class="last"[/#if]>
							...
							<td>
								<a href="edit.html?id=${receiver.id}">[${message("shop.member.handle.edit")}]</a>
