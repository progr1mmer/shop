...
<title>${message("shop.member.message.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
				...
				<table id="listTable" class="list">
					...
					[#list page.content as memberMessage]
						<tr[#if !memberMessage_has_next] class="last"[/#if]>
							...
							<td>
								<a href="view.html?id=${memberMessage.id}">[${message("shop.member.handle.view")}]</a>
