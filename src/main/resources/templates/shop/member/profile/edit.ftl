...
<title>${message("shop.member.profile.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
					...
					<table class="input">
						...
						<tr>
							...
							<td>
								...
								<input type="button" class="button" value="${message("shop.member.back")}" onclick="location.href='../index.html'" />
							</td>
						</tr>
					</table>
				</form>
