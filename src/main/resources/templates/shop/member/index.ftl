...
<title>${message("shop.member.index")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
					...
					<div>
						<ul>
							...
							<li>
								...
								<em>${member.point}</em>
								<a href="coupon_code/exchange.html">${message("shop.member.index.exchange")}</a>
							</li>
						</ul>
						<ul>
							<li>
								<a href="order/list.html">${message("shop.member.index.waitingPaymentOrderCount")}(<em>${waitingPaymentOrderCount}</em>)</a>
								<a href="order/list.html">${message("shop.member.index.waitingShippingOrderCount")}(<em>${waitingShippingOrderCount}</em>)</a>
							</li>
							<li>
								<a href="message/list.html">${message("shop.member.index.messageCount")}(<em>${messageCount}</em>)</a>
								<a href="coupon_code/list.html">${message("shop.member.index.couponCodeCount")}(<em>${couponCodeCount}</em>)</a>
							</li>
							<li>
								<a href="favorite/list.html">${message("shop.member.index.favoriteCount")}(<em>${favoriteCount}</em>)</a>
								<a href="product_notify/list.html">${message("shop.member.index.productNotifyCount")}(<em>${productNotifyCount}</em>)</a>
							</li>
							<li>
								<a href="review/list.html">${message("shop.member.index.reviewCount")}(<em>${reviewCount}</em>)</a>
								<a href="consultation/list.html">${message("shop.member.index.consultationCount")}(<em>${consultationCount}</em>)</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<table class="list">
						...
						[#list newOrders as order]
							<tr[#if !order_has_next] class="last"[/#if]>
								...
								<td>
									<a href="order/view.html?sn=${order.sn}">[${message("shop.member.handle.view")}]</a>
								</td>
							</tr>
						[/#list]
					</table>
