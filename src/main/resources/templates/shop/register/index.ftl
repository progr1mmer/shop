...
<title>${message("shop.register.title")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
<meta name="author" content="progr1mmer" />
<link href="${base}/shop/css/common.css" rel="stylesheet" type="text/css" />
<link href="${base}/shop/css/register.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${base}/shop/datePicker/WdatePicker.js"></script>
		...
		<div class="span29">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${base}/register/submit" method="post">
						<table>
							<tr>
								<th>
						...
						<div class="login">
							...
							<dl>
								...
								<dd>
									...
									<a href="${base}/login.html">${message("shop.register.login")}</a>
								</dd>
							</dl>
						</div>
					</form>
