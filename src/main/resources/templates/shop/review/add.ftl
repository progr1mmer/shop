...
<title>${product.name} ${message("shop.review.title")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<link href="${base}/shop/css/review.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${base}/shop/js/jquery.js"></script>
<script type="text/javascript" src="${base}/shop/js/jquery.rating.js"></script>
				...
				success: function(message) {
					...
					if (message.type == "success") {
						setTimeout(function() {
							...
							location.href = "../content/${product.id}.html";
						}, 3000);
					} else {
						$submit.prop("disabled", false);
