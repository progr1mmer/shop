	...
	[#if setting.reviewAuthority != "anyone"]
		$addReview.click(function() {
			if ($.checkLogin()) {
				...
				$.redirectLogin("${base}/review/add/${product.id}.html", "${message("shop.review.accessDenied")}");
				return false;
			}
		});
	[/#if]
			...
			<table class="info">
				<tr>
					...
					<td class="handle" rowspan="3">
						<a href="${base}/review/add/${product.id}.html" id="addReview">[${message("shop.review.add")}]</a>
					</td>
				</tr>
				<tr>
					<td>
