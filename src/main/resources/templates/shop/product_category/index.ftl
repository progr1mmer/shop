...
<title>${message("shop.productCategory.title")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<link href="${base}/shop/css/product_category.css" rel="stylesheet" type="text/css" />
