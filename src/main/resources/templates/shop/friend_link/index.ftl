...
<title>${message("shop.friendLink.title")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<link href="${base}/shop/css/friend_link.css" rel="stylesheet" type="text/css" />
