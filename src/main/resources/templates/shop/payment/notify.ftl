...
<title>${message("shop.payment.notify")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
<meta name="author" content="progr1mmer" />
<link href="${base}/shop/css/common.css" rel="stylesheet" type="text/css" />
<link href="${base}/shop/css/payment.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="container payment">
		<div class="span24">
			...
			<div class="bottom">
				[#if payment.type == "payment"]
					<a href="${base}/member/order/view.html?sn=${payment.order.sn}">${message("shop.payment.viewOrder")}</a>
				[#elseif payment.type == "recharge"]
					<a href="${base}/member/deposit/list.html">${message("shop.payment.deposit")}</a>
				[/#if]
