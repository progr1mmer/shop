...
[@seo type = "productSearch"]
	<title>[#if seo.title??][@seo.title?interpret /][/#if][#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<script type="text/javascript" src="${base}/shop/js/jquery.lazyload.js"></script>
...
<body>
	...
	<div class="container productList">
				...
				[@product_category_root_list]
					[#list productCategories as category]
						<dl[#if !category_has_next] class="last"[/#if]>
							<dt>
								<a href="${base}${category.path}" class="a1">${category.name}</a>
							</dt>
							[@product_category_children_list productCategoryId = category.id count = 4]
								[#list productCategories as productCategory]
									<dd>
										<a href="${base}${productCategory.path}" class="a2">${productCategory.name}</a>
									</dd>
								[/#list]
		...
		<div class="span18 last">
			...
			<form id="productForm" action="${base}/product/search.html" method="get">
		...
		<div class="span29">
			  <div class="links">
					<div align="center">
						...
						<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=123456789&site=qq&menu=yes"><img src="/shop/images/guanyu2.jpg" /></a>
					</div>
			 </div>
		</div>
	</div>
