...
<link href="${base}/shop/css/article.css" rel="stylesheet" type="text/css" />
	...
	<div class="container articleList">
		<div class="span6">
			...
			<div class="articleSearch">
				...
				<div class="content">
					<form id="articleSearchForm" action="${base}/article/search.html" method="get">
		...
		<div class="span18 last">
			...
			[@pagination pageNumber = page.pageNumber totalPages = page.totalPages pattern = "search.html?keyword=${articleKeyword}&pageNumber={pageNumber}"]
