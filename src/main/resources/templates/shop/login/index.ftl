...
<title>${message("shop.login.title")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
<meta name="author" content="progr1mmer" />
<link href="${base}/shop/css/common.css" rel="stylesheet" type="text/css" />
<link href="${base}/shop/css/login.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${base}/shop/js/jsbn.js"></script>
<script type="text/javascript" src="${base}/shop/js/prng4.js"></script>
<script type="text/javascript" src="${base}/shop/js/rng.js"></script>
<script type="text/javascript" src="${base}/shop/js/rsa.js"></script>
<script type="text/javascript" src="${base}/shop/js/base64.js"></script>
...
<body>
	...
	<div class="container login">
		<div class="span12">
			<div class="ad1"><img src="${base}/shop/images/BgImg.gif" width="1500px" height="750px" alt="会员登录" title="会员登录" /></div>
		</div>
		<div class="span27">
			<div class="wrap">
				<div class="main">
					...
					<form id="loginForm" action="${base}/login/submit" method="post">
						<table height="340px">
							<tbody>
							<tr>
								<th>
							...
							[#if setting.captchaTypes?? && setting.captchaTypes?seq_contains("memberLogin")]
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" /><img id="captchaImage" class="captchaImage" src="${base}/common/captcha.html?captchaId=${captchaId}" title="${message("shop.captcha.imageTitle")}" />
										</span>
									</td>
								</tr>
							[/#if]
							<tr>
								...
								<td>
									...
									<label>
										&nbsp;&nbsp;<a href="${base}/password/find.html">${message("shop.login.findPassword")}</a>
									</label>
								</td>
							</tr>
							<tr>
								...
								<td>
									<dl>
										...
										<dd>
											...
											<a href="${base}/register.html">${message("shop.login.register")}</a>
										</dd>
									</dl>
								</td>
							</tr>
