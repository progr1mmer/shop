...
[@seo type = "brandList"]
	<title>[#if seo.title??][@seo.title?interpret /][#else]${message("shop.brand.title")}[/#if][#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<link href="${base}/shop/css/brand.css" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="container brandList">
		...
		<div class="span18 last">
			...
			[@pagination pageNumber = page.pageNumber totalPages = page.totalPages pattern = "{pageNumber}.html"]
