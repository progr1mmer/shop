...
<title>${message("shop.password.find")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
<meta name="author" content="progr1mmer" />
<link href="${base}/shop/css/common.css" rel="stylesheet" type="text/css" />
<link href="${base}/shop/css/password.css" rel="stylesheet" type="text/css" />
		...
		<div class="span24">
			<div class="wrap">
				<div class="main">
					...
					<form id="passwordForm" action="find" method="post">
