...
<title>${message("admin.sales.view")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<script type="text/javascript" src="${base}/admin/fusionCharts/FusionCharts.js"></script>
...
<script type="text/javascript" src="${base}/admin/datePicker/WdatePicker.js"></script>
...
$().ready(function() {
	...
	var salesAmountChart = new FusionCharts("${base}/admin/fusionCharts/Charts/FCF_Line.swf", "salesAmountChart", "800", "300");
	...
	var salesVolumeChart = new FusionCharts("${base}/admin/fusionCharts/Charts/FCF_Line.swf", "salesVolumeChart", "800", "300");
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.sales.view")}
	</div>
	<form id="inputForm" action="view.html" method="get">
		<table class="input">
			<tr>
				<td colspan="2">
