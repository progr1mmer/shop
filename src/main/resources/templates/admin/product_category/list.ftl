...
<title>${message("admin.productCategory.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.productCategory.list")}
	</div>
	<div class="bar">
		...
		[#list productCategoryTree as productCategory]
			<tr>
				...
				<td>
					...
					<a href="edit.html?id=${productCategory.id}">[${message("admin.common.edit")}]</a>
