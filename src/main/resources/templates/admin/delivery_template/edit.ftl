...
<title>${message("admin.deliveryTemplate.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<script type="text/javascript" src="${base}/admin/js/jquery.event.drag.js"></script>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.deliveryTemplate.edit")}
	</div>
