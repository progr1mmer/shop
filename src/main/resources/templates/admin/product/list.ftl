...
<title>${message("admin.product.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.product.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
				...
				<div class="menuWrap">
					...
					<div class="popupMenu">
						<ul id="filterOption" class="check">
							...
							<li class="separator">
								<a href="javascript:;" name="status" val="1"[#if status?? && status==1] class="checked"[/#if]>待审核</a>
							</li>
							<li>
								<a href="javascript:;" name="status" val="2"[#if status?? && status==2] class="checked"[/#if]>审核通过</a>
							</li>
							<li>
								<a href="javascript:;" name="status" val="3"[#if status?? && status==3] class="checked"[/#if]>审核未通过</a>
							</li>
						</ul>
					</div>
				</div>
