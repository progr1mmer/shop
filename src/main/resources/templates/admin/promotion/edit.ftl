...
<title>${message("admin.promotion.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<script type="text/javascript" src="${base}/admin/js/jquery.autocomplete.js"></script>
...
$().ready(function() {
	...
	// 商品选择
	$productSelect.autocomplete("product_select", {
		dataType: "json",
		max: 20,
		width: 600,
		scrollHeight: 300,
	...
	// 赠品选择
	$giftSelect.autocomplete("gift_select.html", {
		dataType: "json",
		max: 20,
		width: 600,
		scrollHeight: 300,
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.promotion.edit")}
	</div>
