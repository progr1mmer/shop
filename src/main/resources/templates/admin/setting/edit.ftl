...
<title>${message("admin.setting.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<script type="text/javascript" src="${base}/admin/js/jquery.tools.js"></script>
...
<script type="text/javascript" src="${base}/admin/js/input.js"></script>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.setting.edit")}
	</div>
	<form id="inputForm" action="update" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>${message("Setting.version")}:
                </th>
                <td>
                    <input type="text" name="version" class="text" value="${setting.version}" maxlength="200" />
                </td>
            </tr>
            <tr>
                <th>
					${message("Setting.isShowPowered")}:
                </th>
                <td>
                    <input type="checkbox" name="isShowPowered" value="true"[#if setting.isShowPowered] checked="checked"[/#if] />
                    <input type="hidden" name="_isShowPowered" value="false" />
                </td>
            </tr>
            <tr>
                <th>
                    ${message("Setting.powered")}:
                </th>
                <td>
                    <input type="text" name="powered" class="text" value="${setting.powered}" maxlength="200" />
                </td>
            </tr>
            <tr>
                <th>
					${message("Setting.isShowCopyright")}:
                </th>
                <td>
                    <input type="checkbox" name="isShowCopyright" value="true"[#if setting.isShowCopyright] checked="checked"[/#if] />
                    <input type="hidden" name="_isShowCopyright" value="false" />
                </td>
            </tr>
            <tr>
                <th>
                    ${message("Setting.copyright")}:
                </th>
                <td>
		...
		<table class="input">
			<tr>
				...
				<td>
					...
					<input type="button" class="button" value="${message("admin.common.back")}" onclick="location.href='../common/index.html'" />
				</td>
			</tr>
		</table>
	</form>
