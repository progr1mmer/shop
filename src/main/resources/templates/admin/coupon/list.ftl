...
<title>${message("admin.coupon.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.coupon.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as coupon]
				<tr>
					...
					<td>
						<a href="build.html?id=${coupon.id}">[${message("admin.coupon.build")}]</a>
						<a href="edit.html?id=${coupon.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
