...
<title>${message("admin.admin.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
$().ready(function() {
	...
	var AjaxURL= "../account/showAccount.html";
	var admin=${admin.id};
	$.post(AjaxURL,
			{
			 admin:admin},
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.admin.edit")}
	</div>
