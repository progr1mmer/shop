...
<title>${message("admin.role.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.role.edit")}
	</div>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:accountAudit" [#if role.authorities?seq_contains("admin:accountAudit")] checked="checked"[/#if] />${message("admin.role.accountAudit")}
						</label>
