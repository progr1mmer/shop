...
<title>${message("admin.unauthorized.title")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
<meta name="author" content="progr1mmer" />
<link href="${base}/admin/css/common.css" rel="stylesheet" type="text/css" />
<link href="${base}/admin/css/error.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<div class="wrap">
		<div class="error">
