...
<title>${message("admin.static.build")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.static.build")}
	</div>
	<form id="inputForm" action="build" method="post">
		<table class="input">
			<tr>
				<th>
