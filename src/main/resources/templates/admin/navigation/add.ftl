...
<title>${message("admin.navigation.add")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.navigation.add")}
	</div>
			...
			<tr>
				...
				<td>
					<select id="systemUrl">
						...
						<option value="${base}/product_category.html">${message("admin.navigation.productCategory")}</option>
						<option value="${base}/friend_link.html">${message("admin.navigation.friendLink")}</option>
						<option value="${base}/member/index.html">${message("admin.navigation.member")}</option>
