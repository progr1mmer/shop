...
<title>${message("admin.navigation.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.navigation.list")}
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list topNavigations as navigation]
				<tr>
					...
					<td>
						<a href="edit.html?id=${navigation.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
