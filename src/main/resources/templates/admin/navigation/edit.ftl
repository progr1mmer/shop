...
<title>${message("admin.navigation.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.navigation.edit")}
	</div>
			...
			<tr>
				...
				<td>
					<select id="systemUrl">
						...
						<option value="${base}/product_category.html"[#if navigation.url == base + "/product_category.html"] selected="selected"[/#if]>${message("admin.navigation.productCategory")}</option>
						<option value="${base}/friend_link.html"[#if navigation.url == base + "/friend_link.html"] selected="selected"[/#if]>${message("admin.navigation.friendLink")}</option>
						<option value="${base}/member/index.html"[#if navigation.url == base + "/member/index.html"] selected="selected"[/#if]>${message("admin.navigation.member")}</option>
