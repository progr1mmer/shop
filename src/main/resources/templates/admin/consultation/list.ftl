...
<title>${message("admin.consultation.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.consultation.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as consultation]
				<tr>
					...
					<td>
						<a href="reply.html?id=${consultation.id}">[${message("admin.consultation.reply")}]</a>
						<a href="edit.html?id=${consultation.id}">[${message("admin.common.edit")}]</a>
