...
<title>${message("admin.consultation.reply")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.consultation.reply")}
	</div>
			...
			<tr>
				...
				<td colspan="2">
					[#if consultation.member??]
						<a href="../member/view.html?id=${consultation.member.id}">${consultation.member.username}</a>
					[#else]
