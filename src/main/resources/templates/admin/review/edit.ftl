...
<title>${message("admin.review.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.review.edit")}
	</div>
	<form id="inputForm" action="update" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					[#if review.member??]
						<a href="../member/view.html?id=${review.member.id}">${review.member.username}</a>
					[#else]
