...
<title>${message("admin.message.view")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.message.view")}
	</div>
				...
				<tr>
					<th>
						[#if replyMessage.sender??]
							<a href="${base}/admin/member/view.html?id=${replyMessage.sender.id}">
