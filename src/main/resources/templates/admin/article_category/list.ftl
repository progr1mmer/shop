...
<title>${message("admin.articleCategory.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.articleCategory.list")}
	</div>
	<div class="bar">
		...
		[#list articleCategoryTree as articleCategory]
			<tr>
				...
				<td>
					...
					<a href="edit.html?id=${articleCategory.id}">[${message("admin.common.edit")}]</a>
