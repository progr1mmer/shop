...
<title>${message("admin.memberRank.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
	...
	$inputForm.validate({
		rules: {
			...
			amount: {
				...
				remote: {
					url: "check_amount?previousAmount=${memberRank.amount}",
					cache: false
				}
			}
		},
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.memberRank.edit")}
	</div>
