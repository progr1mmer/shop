...
<title>${message("admin.order.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.order.edit")}
	</div>
	<ul id="tab" class="tab">
		<li>
	...
	<form id="inputForm" action="update" method="post">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<a href="../member/view.html?id=${order.member.id}">${order.member.username}</a>
				</td>
			</tr>
			<tr>
				<th>
