...
<title>${message("admin.deliveryCorp.edit")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
$().ready(function() {
	...
	// 物流公司选择
	$.ajax({
		url: "${base}/admin/xml/delivery_corp.xml",
		type: "GET",
		dataType: "xml",
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.deliveryCorp.edit")}
	</div>
