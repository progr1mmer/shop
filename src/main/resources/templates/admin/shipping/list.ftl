...
<title>${message("admin.shipping.list")}[#if setting.isShowPowered] - ${setting.powered}[/#if]</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.html">${message("admin.path.index")}</a> &raquo; ${message("admin.shipping.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as shipping]
				<tr>
					...
					<td>
						<a href="view.html?id=${shipping.id}">[${message("admin.common.view")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
