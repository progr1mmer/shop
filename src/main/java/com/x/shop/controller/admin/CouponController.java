...
import com.x.shop.common.ExcelView;
...
public class CouponController extends BaseController {
     ...
     * 生成优惠码
     */
    @RequestMapping(value = "/build.html", method = RequestMethod.GET)
    public String build(Long id, ModelMap model) {
        Coupon coupon = couponService.find(id);
        model.addAttribute("coupon", coupon);
        model.addAttribute("totalCount", couponCodeService.count(coupon, null, null, null));
        model.addAttribute("usedCount", couponCodeService.count(coupon, null, null, true));
    ...
    public ModelAndView download(Long id, Integer count, ModelMap model) {
        ...
        Coupon coupon = couponService.find(id);
        List<CouponCode> data = couponCodeService.build(coupon, count);
