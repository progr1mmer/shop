...
public class Setting implements Serializable {
     ...
     * 是否显示版权信息
     */
    private Boolean isShowCopyright;
     ...
     */
    @NotNull
    public Boolean getIsShowPowered() {
        return isShowPowered;
    }
     ...
     * @param isShowPowered
     */
    public void setIsShowPowered(Boolean isShowPowered) {
        this.isShowPowered = isShowPowered;
    }
     ...
     * 设置是否显示版权信息
     *
     * @param isShowCopyright
     */
    public void setIsShowCopyright(Boolean isShowCopyright) {
