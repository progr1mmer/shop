package com.x.shop.plugin.paypal;
...
public class PaypalController extends BaseController {
    ...
    public String setting(ModelMap model) {
        PluginConfig pluginConfig = paypalPlugin.getPluginConfig();
        model.addAttribute("currencies", PaypalPlugin.Currency.values());
        model.addAttribute("feeTypes", PaymentPlugin.FeeType.values());
        model.addAttribute("pluginConfig", pluginConfig);
        return "/plugin/paypal/setting";
    }
    ...
    public String update(String paymentName, String partner, PaypalPlugin.Currency currency, PaymentPlugin.FeeType feeType, BigDecimal fee, String logo, String description, @RequestParam(defaultValue = "false") Boolean isEnabled, Integer order, RedirectAttributes redirectAttributes) {
        PluginConfig pluginConfig = paypalPlugin.getPluginConfig();
